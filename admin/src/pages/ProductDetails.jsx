            ...
            <div className="w-full flex flex-col p-5 md:p-8 text-left">
              ...
              <div className="mt-6">
                <button
                  ...
                  className="cursor-pointer leading-5 transition-colors duration-150 font-medium text-sm focus:outline-none px-5 py-2 rounded-md text-white bg-purple-500 border border-transparent active:bg-purple-600 hover:bg-purple-600 "
                >
                  {t("EditProduct")}
                </button>
              </div>
