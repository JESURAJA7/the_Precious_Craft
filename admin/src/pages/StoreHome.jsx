  ...
  return (
    <>
      <div className="py-6 flex justify-between text-center items-center">
        ...
        <div className="pb-4">
          {console.log(register,"register",language,handleSelectLanguage)}
          {/* <SelectLanguageTwo
            register={register}
            language={languages}
        ...
        <ul className="sm:flex grid grid-cols-3 text-sm font-medium text-center text-gray-500 sm:divide-x divide-gray-200 rounded-lg dark:divide-gray-700 dark:text-gray-400 mb-5">
          <li>
            <Link
              ...
              } hover:text-white hover:bg-purple-500  focus:outline-none dark:hover:text-white dark:hover:bg-purple-500 sm:rounded-l-md rounded-tl-md`}
            >
            ...
            <Link
              ...
              className={`inline-block w-full py-3 px-4 shadow-md ${
                tabName === "single-setting"
                  ? "bg-purple-500 text-white dark:bg-purple-500 dark:text-white"
                  : "bg-gray-200 text-gray-800 font-medium dark:bg-gray-600 dark:text-gray-300"
              } hover:text-white hover:bg-purple-500  focus:outline-none dark:hover:text-white dark:hover:bg-purple-500`}
            >
              <span className="text-sm font-medium font-serif xl:inline-block hidden">
                {t("SingleSetting")}
              </span>
            ...
            <Link
              ...
              className={`inline-block w-full py-3 px-4 shadow-md ${
                tabName === "about-us-setting"
                  ? "bg-purple-500 text-white dark:bg-purple-500 dark:text-white"
                  : "bg-gray-200 text-gray-800 font-medium dark:bg-gray-600 dark:text-gray-300"
              } hover:text-white hover:bg-purple-500 focus:outline-none dark:hover:text-white dark:hover:bg-purple-500 sm:rounded-tr-none rounded-tr-md`}
            >
              <span className="text-sm font-medium font-serif xl:inline-block hidden">
                {t("AboutUsSetting")}
              </span>
            ...
            <Link
              ...
              className={`inline-block w-full py-3 px-4 shadow-md ${
                tabName === "contact-us-setting"
                  ? "bg-purple-500 text-white dark:bg-purple-500 dark:text-white"
                  : "bg-gray-200 text-gray-800 font-medium dark:bg-gray-600 dark:text-gray-300"
              } hover:text-white hover:bg-purple-500  focus:outline-none dark:hover:text-white dark:hover:bg-purple-500 sm:rounded-bl-none rounded-bl-md`}
            >
              <span className="text-sm font-medium font-serif xl:inline-block hidden">
                {t("ContactUsStting")}
              </span>
