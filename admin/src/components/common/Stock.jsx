      ...
      {stock <= 0 ? (
        ...
        <span>
          <span
            className={`${
              card
                ? "bg-gray-100 dark:bg-gray-600 text-purple-500 rounded-full text-xs px-2 py-0 font-medium"
                : "bg-puple-100 dark:bg-gray-600 text-purple-500 rounded-full inline-flex items-center justify-center px-2 py-0 text-xs font-semibold  font-serif"
            }`}
          >
            Stock :
