    ...
    .map((route) => {
      ...
      if (route.routes) {
        const validSubRoutes = route.routes.filter((subRoute) => {
          ...
          return accessList.includes(routeKey) || role === "super admin";
        });
      ...
      return (routeKey && accessList.includes(routeKey)) ||
        role === "super admin"
        ? route
        : null;
    })
          ...
          route.routes ? (
            ...
            <li className="relative" key={route.name}>
              <NavLink
                ...
                className="px-6 py-4 inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-primary dark:hover:text-gray-200"
                activeClassName="text-primary dark:text-gray-100"
                rel="noreferrer"
              >
