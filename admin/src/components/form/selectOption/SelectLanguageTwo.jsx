  ...
  return (
    <>
      <select
        ...
        className="block w-20 h-8 border border-purple-400 bg-gray-100 dark:bg-gray-700 px-2 py-1 text-sm dark:text-gray-300 focus:outline-none rounded-md form-select focus:bg-white dark:focus:bg-gray-700"
      >
