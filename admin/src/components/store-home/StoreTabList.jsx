      ...
      <ul className="sm:flex grid grid-cols-3 text-sm font-medium text-center text-gray-500 sm:divide-x divide-gray-200 rounded-lg dark:divide-gray-700 dark:text-gray-400 mb-5">
        <li>
          <Link
            ...
            className={`inline-block w-full p-4 shadow bg-white hover:text-white hover:bg-purple-500  focus:outline-none dark:hover:text-white dark:bg-gray-800 dark:hover:bg-purple-500 rounded-l-md`}
          >
        ...
        <li>
          <Link
            ...
            className={`inline-block w-full p-4 shadow bg-white hover:text-white hover:bg-purple-500  focus:outline-none dark:hover:text-white dark:bg-gray-800 dark:hover:bg-purple-500`}
          >
            <span className="text-sm font-medium font-serif xl:inline-block hidden">
              {t("SingleSetting")}
            </span>
