          ...
          >
            <div className="grid grid-cols-1 gap-5">
                ...
                <>
                  ...
                  <div className="form-group">
                    <input
                      ...
                      className="py-2 px-4 md:px-5 w-full appearance-none border text-sm opacity-75 text-input rounded-md placeholder-body min-h-12 transition duration-200 focus:ring-0 ease-in-out bg-gray-100 border-gray-200 focus:outline-none focus:border-purple-500 h-11 md:h-12"
                    />
              ...
              <button
                disabled={loading}
                type="submit"
                className="w-full text-center py-3 rounded bg-purple-500 font-medium text-sm text-white hover:bg-purple-600 transition-all focus:outline-none my-1"
              >
