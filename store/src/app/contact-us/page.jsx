...
export const metadata = {
  title: "Contact Us | Preciouscraft",
  description:
          ...
          <div className="grid md:grid-cols-2 gap-6 lg:grid-cols-3 xl:gap-8 ">
            {error ? (
              ...
              <div className="border p-10 rounded-lg text-center">
                <span className="flex justify-center text-4xl text-purple-500 mb-4">
                  <FiMail />
                </span>
              ...
              >
                ...
                <div className="flex flex-col space-y-5">
                  ...
                  <div className="relative">
                    <button
                      data-variant="flat"
                      className="md:text-sm leading-4 inline-flex items-center cursor-pointer transition ease-in-out duration-300 font-semibold text-center justify-center border-0 border-transparent rounded-md placeholder-white focus-visible:outline-none focus:outline-none bg-purple-500 text-white px-5 md:px-6 lg:px-8 py-3 md:py-3.5 lg:py-3 hover:text-white hover:bg-purple-600 h-12 mt-1 text-sm lg:text-base w-full sm:w-auto"
                    >
                      Send Message
                    </button>
                  </div>
