  ...
  return (
    <>
      <div className="hidden lg:block xl:block bg-purple-100 border-b">
        <div className="max-w-screen-2xl mx-auto px-3 sm:px-10 h-12 flex justify-center items-center">
...
{/*                     
                          ...
                          <div className="rounded-lg shadow-lg overflow-y-scroll flex-grow scrollbar-hide w-full h-full">
                            <div className="relative grid gap-2 px-6 py-6">
                              {navbar?.offers_menu_status && (
                                <span className="p-2 items-center rounded-md hover:bg-gray-50 w-full hover:text-purple-600">
                                  <div className="w-full flex">
                                    <Gift className="my-auto h-5 w-5 text-gray-700" />
                                    <Link
                                      href="/offers"
                                      onClick={() => setIsLoading(!isLoading)}
                                      className="relative inline-flex items-center  ml-2 py-0 rounded text-sm font-medium  hover:text-purple-600"
                                    >
                    ...
                    {/* {navbar?.offers_menu_status && (
                      <Link
                        href="/offers"
                        onClick={() => setIsLoading(!isLoading)}
                        className="relative inline-flex items-center  bg-red-100  ml-4 py-0 px-2 rounded text-sm font-medium text-red-500 hover:text-purple-600"
                      >
                        {showingTranslateValue(navbar?.offers)}
