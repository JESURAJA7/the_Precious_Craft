        ...
        <div className="rounded-md">
          {error ? (
            ...
            <div className="text-center">
              <span className="flex justify-center my-30 pt-16 text-purple-500 font-semibold text-6xl">
                <IoBagHandle />
              </span>
                                ...
                                <td className="px-4 text-sm whitespace-nowrap text-end">
                                  {link ? (
                                    <Link href={`/order/${order._id}`}>
                                      <span className="text-purple-500 text-end cursor-pointer hover:text-purple-700 transition-all p-3 font-semibold rounded-full flex items-center justify-end gap-1.5">
                                    ...
                                    <span
                                      ...
                                      className="text-purple-500 text-end cursor-pointer hover:text-purple-700 transition-all p-3 font-semibold rounded-full flex items-center justify-end gap-1.5"
                                    >
                                      <Eye className="h-4 w-4" />
                                    </span>
                                  )}
