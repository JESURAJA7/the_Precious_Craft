        ...
        <div className="container mx-auto px-3 sm:px-10 max-w-screen-2xl">
          <div className="flex items-center py-6 lg:py-8">
            <ol className="flex items-center w-full overflow-hidden ">
              <li className="text-sm pr-1 transition duration-200 ease-in cursor-pointer hover:text-purple-500 font-semibold">
                <Link href="/">Home</Link>
              </li>
              ...
              <li className="text-sm pl-1 transition duration-200 ease-in cursor-pointer hover:text-purple-500 font-semibold ">
                <Link
          ...
          <div className="relative lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-4 lg:gap-y-8">
            ...
            <div className="lg:sticky top-44 mt-6 lg:mt-0 self-start z-10 mx-auto lg:col-span-4 lg:row-span-2 lg:row-end-2 lg:max-w-none">
              ...
              <div className="mb-6 p-4 bg-gradient-to-br from-amber-50/50 to-white border border-gold/20 rounded-lg">
                ...
                <dl className="grid grid-cols-2 gap-3 text-sm">
                  {product?.metal && (
                    <>
                      <dt className="text-gray-600 font-medium">Metal Type:</dt>
                      <dd className="text-gray-900 font-semibold capitalize flex items-center">
                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gradient-to-r from-yellow-100 to-amber-100 text-amber-800 border border-amber-200">
                          {product.metal}
                        </span>
                      </dd>
                    </>
                  ...
                  {product?.weight && (
                    <>
                      ...
                      <dd className="text-gray-900 font-semibold">{product.weight}g</dd>
                    </>
                  )}
                  {product?.sku && (
                    <>
                      <dt className="text-gray-600 font-medium">SKU:</dt>
                      <dd className="text-gray-900 font-mono text-xs">{product.sku}</dd>
                    </>
                  )}
                  {product?.barcode && (
                    <>
                      <dt className="text-gray-600 font-medium">Barcode:</dt>
                      <dd className="text-gray-900 font-mono text-xs">{product.barcode}</dd>
                    </>
                  )}
                  {product?.productId && (
                    <>
                      <dt className="text-gray-600 font-medium">Product ID:</dt>
                      <dd className="text-gray-900 font-mono text-xs">{product.productId}</dd>
                    </>
                  )}
                </dl>
              </div>
              ...
              <TabGroup>
                <div className="border-b border-gray-200">
                  <TabList className="-mb-px flex space-x-8">
                    <Tab className="cursor-pointer border-b-2 border-transparent pb-3 text-sm font-medium whitespace-nowrap text-gray-700 hover:border-gray-300 focus:outline-0 hover:text-gray-800 data-selected:border-purple-600 data-selected:text-purple-600">
                      Customer Reviews
                    </Tab>
