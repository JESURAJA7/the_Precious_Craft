          ...
          <Link href={item.url} className="block">
            ...
            <div className="absolute top-0 left-0 z-10 p-r-16 flex-col flex w-full text-center justify-center">
              <div className="pt-4">
                ...
                <button className="hidden sm:block lg:block text-xs mx-auto leading-6  font-medium mt-4 px-4 py-1 bg-purple-500 text-center rounded-full text-white hover:bg-purple-600">
                  Shop Now
                </button>
              </div>
            </div>
