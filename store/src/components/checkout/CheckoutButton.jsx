...
const CheckoutButton = ({ stripe, isEmpty, storeCustomizationSetting }) => {
  ...
  return (
    <button
      ...
      className="bg-purple-500 hover:bg-purple-600 border cursor-pointer border-purple-500 transition-all rounded py-3 text-center text-sm font-medium text-white flex justify-center w-full"
    >
      {pending ? (
