  ...
  return (
    ...
    <>
      <form
        ...
        className="relative pr-12 md:pr-14 bg-white overflow-hidden shadow-sm rounded-md w-[400px]"
      >
        <label className="flex items-center py-0.5">
          <Input
            onChange={(e) => setSearchText(e.target.value)}
            value={searchText}
            className="form-input w-full pl-10 appearance-none transition ease-in-out text-sm text-gray-700 font-sans rounded-md h-9 duration-200 bg-white focus:ring-0 outline-none border-none focus:outline-none"
