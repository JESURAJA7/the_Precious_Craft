...
const OfferCard = async () => {
  ...
  return (
    <div className="w-full group dark:bg-zinc-900">
      <div className="bg-gray-50 dark:bg-slate-600 h-full border-2 border-orange-500 transition duration-150 ease-linear transform group-hover:border-purple-500 rounded shadow">
