                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-2">
                    {dayjs().isAfter(dayjs(coupon.endTime)) ? (
                      ...
                      <span className="text-purple-600 inline-block px-4 py-1 rounded-full font-medium text-xs bg-purple-100">
                        Active
                      </span>
                    )}
                  </div>
            ...
            <div className="md:border-l-2 lg:border-l-2 border-dashed lg:w-1/3 md:w-1/3 relative px-4">
              <div className="info flex items-center">
                <div className="w-full">
                  <div className="block">
                    <div className=" border border-dashed bg-purple-50 py-1 border-purple-300 rounded-lg text-center block">
              ...
              <div className="info flex lg:my-6 md:my-5 mb-6 items-center">
                <div className="w-full">
                  <div className="block">
                    ...
                    <div className=" border border-dashed bg-purple-50 py-2 border-purple-300 rounded-lg text-center block">
                      <CouponCodeButton coupon={coupon} />
                    </div>
                  </div>
