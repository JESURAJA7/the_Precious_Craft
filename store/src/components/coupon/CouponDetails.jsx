          ...
          <div className="info flex lg:my-6 md:my-5 mb-6 items-center">
            <div className="w-full">
              <div className="block">
                ...
                <div className="font-serif border border-dashed bg-purple-50 py-2 border-purple-300 rounded-lg text-center block">
                  <CopyToClipboard
                  ...
                  >
                    <button className="block w-full">
                      {copied && coupon.couponCode === copiedCode ? (
                        <span className="text-purple-600 text-base leading-7 font-semibold">
                          Copied!
                        </span>
                      ) : (
                        <span className="uppercase font-serif font-semibold text-base leading-7 text-purple-600">
                          {coupon.couponCode}{" "}
                        </span>
                      )}
                    </button>
