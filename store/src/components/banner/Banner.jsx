      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className=" text-xl">
            <span className="text-purple-600 dark:text-gray-200 font-bold">
        ...
        <Link
          ...
          className="text-sm  font-medium px-6 py-2 bg-purple-500 text-center rounded-full text-white hover:bg-purple-700"
        >
